...
\begin{document}
    ...
    \begin{rem}
        ...
        \begin{itemize}
            ...
            \begin{displaymath}
                \mathbb{E}(X) = \int_\R x^r f(x) \textnormal{d}x
            \end{displaymath}
            ...
            Si c'est le cas, alors :
            \begin{displaymath}
                \mathbb{E}(X) = \sum_{k=0}^{+\infty} k^r \Pb(X=k)
            \end{displaymath}
    ...
    \begin{rem}
        ...
        \begin{itemize}
            ...
            \begin{displaymath}
                \mathbb{E}(g \circ X) = \int_E g(x)f(x)\textnormal{d}x
            \end{displaymath}
            ...
            \begin{displaymath}
                \mathbb{E}(g \circ X) = \sum_{k=0}^{+\infty} g(k) \Pb(X = k)
            \end{displaymath}
        \end{itemize}
    \end{rem}
